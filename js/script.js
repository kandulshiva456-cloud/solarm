...
const SERVICES = [
  {
    ...
    detail: 'A documented operations and maintenance programme covering the eight client-defined O&M service scopes.',
...
const OM_ITEMS = [
  { name: 'Module Cleaning', text: 'Professional PV module cleaning with manual and robotic options to remove dust, dirt, and surface contaminants and support plant generation.' },
...
const OM_IMAGES = {
  ...
  'Inverter Maintenance': 'assets/optimized/site/electrical-maintenance/inverter-maintenance-5.webp',
...
const OM_IMAGE_GALLERIES = {
  'Module Cleaning': ['assets/optimized/site/om-module-cleaning/module-cleaning-1.webp','assets/optimized/site/om-module-cleaning/module-cleaning-2.webp','assets/optimized/site/om-module-cleaning/module-cleaning-4.webp','assets/optimized/site/om-module-cleaning/module-cleaning-5.webp','assets/optimized/site/om-module-cleaning/module-cleaning-6.webp'],
  'Inverter Maintenance': ['assets/optimized/site/electrical-maintenance/inverter-maintenance-5.webp','assets/optimized/site/electrical-maintenance/inverter-maintenance-6.webp','assets/optimized/site/electrical-maintenance/inverter-maintenance-4.webp','assets/optimized/site/electrical-maintenance/inverter-maintenance-1.webp','assets/optimized/site/electrical-maintenance/inverter-maintenance-2.webp','assets/optimized/site/electrical-maintenance/inverter-maintenance-3.webp','assets/optimized/client-supplied/inverter-maintenance/o-m-inverter-temperature.webp','assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-14-13-pm.webp','assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-14-06-pm-2.webp','assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-15-16-pm.webp','assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-16-35-pm.webp'],
  'Plant Monitoring & Performance': ['assets/optimized/site/plant/solar-plant-overview.webp'],
  'Reporting': ['assets/optimized/site/plant/reporting-stock.webp','assets/optimized/client-supplied/reporting/string-report.webp'],
...
const MODULE_CLEANING_METHODS = {
  manual: {
    title: 'Manual Cleaning',
    desc: 'Manual brush-and-water cleaning for module surface care.',
    images: [
      'assets/optimized/site/om-module-cleaning/module-cleaning-1.webp',
      'assets/optimized/site/om-module-cleaning/module-cleaning-2.webp',
      'assets/optimized/site/om-module-cleaning/module-cleaning-4.webp'
    ]
  },
  robot: {
    title: 'Robot Cleaning',
    desc: 'Robotic module cleaning for repeatable field coverage.',
    images: [
...
const GALLERY = [
  ...
  { src: 'assets/optimized/site/epc-construction/epc-construction.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Solar module installation and field construction', wide: true },
  ...
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-1.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter maintenance — inspection' },
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-2.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter checks at plant' },
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-3.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter — periodic maintenance' },
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-4.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Plant maintenance activity' },
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-5.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter maintenance — checks' },
  { src: 'assets/optimized/site/electrical-maintenance/inverter-maintenance-6.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter internal checks', tall: true },
  ...
  { src: 'assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-15-16-pm.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter fan and equipment maintenance' },
  { src: 'assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-14-06-pm-2.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Electrical panel inspection during maintenance' },
  { src: 'assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-16-35-pm.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Field electrical maintenance check' },
  { src: 'assets/optimized/client-supplied/inverter-maintenance/o-m-inverter-temperature.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter temperature measurement' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-2.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Foundation and setting-out work' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-3.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Solar plant foundation work' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-4.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Electrical installation during project execution' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-5.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Trenching and cable route preparation' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-1.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Foundation and field execution' },
  { src: 'assets/optimized/client-supplied/epc-construction/installation-6.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Solar structure installation' },
  { src: 'assets/optimized/client-supplied/earth-pit/whatsapp-image-2026-08-22-at-4-51-59-pm.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Site foundation and earthing work' },
  { src: 'assets/optimized/client-supplied/earth-pit/whatsapp-image-2026-08-22-at-4-52-03-pm.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Plant site earthing installation' },
  { src: 'assets/optimized/client-supplied/inverter-maintenance/whatsapp-image-2026-07-11-at-8-14-13-pm.webp', cat: 'inverter', tag: 'Plant Maintenance', cap: 'Inverter maintenance field check' },
  { src: 'assets/optimized/client-supplied/epc-construction/site-setting-out-2026-08-22.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Site setting-out and field marking' },
  { src: 'assets/optimized/client-supplied/epc-construction/module-installation-2026-08-22.webp', cat: 'epc', tag: 'EPC PICS', cap: 'PV module installation at site' },
  { src: 'assets/optimized/client-supplied/epc-construction/civil-construction-2026-08-22.webp', cat: 'epc', tag: 'EPC PICS', cap: 'Civil construction during EPC execution' },
  { src: 'assets/optimized/client-supplied/epc-construction/site-construction-2026-06-06.webp', cat: 'plant', tag: 'Plant & Site', cap: 'Solar site construction activity' },
  { src: 'assets/optimized/client-supplied/reporting/string-report.webp', cat: 'monitoring', tag: 'Reporting', cap: 'Inverter and string measurement report' },
  ...
  { src: 'assets/optimized/client-supplied/monitoring-reporting/3-reporting.webp', cat: 'monitoring', tag: 'Reporting', cap: 'Reporting and plant performance records' },
  { src: 'assets/optimized/client-supplied/monitoring-reporting/3-reportings.webp', cat: 'monitoring', tag: 'Reporting', cap: 'Performance reporting reference' },
  { src: 'assets/optimized/client-supplied/monitoring-reporting/plant-monitering-and-performance.webp', cat: 'monitoring', tag: 'Reporting', cap: 'Illustrative performance management view' },
  ];

const GALLERY_FILTERS = [
  { id: 'all', label: 'All' },
  { id: 'plant', label: 'Plant & Site' },
  { id: 'epc', label: 'EPC PICS' },
  { id: 'inverter', label: 'Plant Maintenance' },
  { id: 'cleaning', label: 'Module Cleaning' },
  { id: 'monitoring', label: 'Reporting' },
  { id: 'revamp', label: 'Revamp' },
  { id: 'thermo', label: 'Inspection' },
...
const lightboxMobileOverview = $('#lightboxMobileOverview');
const lightboxOverviewImg = $('#lightboxOverviewImg');
const lightboxOverviewTitle = $('#lightboxOverviewTitle');
const lightboxOverviewCaption = $('#lightboxOverviewCaption');
const lightboxMobileOverviewOpen = $('#lightboxMobileOverviewOpen');
const toastEl = $('#toast');
...
document.addEventListener('click', (e) => {
  ...
  /* service imagery opens directly in the shared lightbox */
  const serviceImage = e.target.closest('.service-gallery-image');
  if (serviceImage) {
    const key = serviceImage.getAttribute('data-service-gallery') || '';
    let entries = [];
    let title = key;
    if (key.startsWith('Module Cleaning / ')) {
      const methodTitle = key.slice('Module Cleaning / '.length);
      const method = Object.values(MODULE_CLEANING_METHODS).find(m => m.title === methodTitle);
      if (method) entries = method.images.map((src, i) => ({ g: { src, tag: method.title, cap: `${method.title} — Maitra field imagery ${i + 1}` }, i }));
    } else {
      const gallery = OM_IMAGE_GALLERIES[key] || (OM_IMAGES[key] ? [OM_IMAGES[key]] : []);
      entries = gallery.map((src, i) => ({ g: { src, tag: key, cap: `${key} — Maitra field imagery ${i + 1}` }, i }));
    }
    if (entries.length) openLightboxEntries(entries, title, false);
    return;
  }

  /* Module Cleaning method galleries */
  const cleaningMethod = e.target.closest('[data-cleaning-method]');
  if (cleaningMethod) {
    openModuleCleaningMethod(cleaningMethod.getAttribute('data-cleaning-method'));
    return;
  }
  ...
  if (filterBtn) {
    ...
    /* On the mobile Projects panel only, a category chip opens that
       category's (or the complete "All") image collection directly —
       the desktop landing gallery keeps its existing filter-only behavior. */
    if (isMobileProjectsView() && filterBtn.closest('.panel-shell[data-panel="projects"]')) {
      if (cat === 'all') openLightboxAll();
      else openLightboxGroup(cat);
    }
    return;
  }
...
function renderOmPanel() {
  const items = OM_ITEMS.map((it,i) => {
    ...
    return `<article class="ix-om-card om-item" data-om-name="${esc(it.name)}" role="listitem">
      <button class="ix-om-card-trigger" type="button" data-om-detail="${esc(it.name)}" aria-label="Open ${esc(it.name)} service details">
        <span class="ix-om-card-media"><img src="${image}" alt="${esc(it.name)}" loading="lazy"><i aria-hidden="true"></i><b>${String(i+1).padStart(2,'0')}</b></span>
        <span class="ix-om-card-copy"><strong>${esc(it.name)}</strong><small>${esc(it.text)}</small><em>VIEW DETAILS <span aria-hidden="true">→</span></em></span>
      </button>
    </article>`;
  }).join('');
...
function openModuleCleaningMethod(methodKey) {
  const method = MODULE_CLEANING_METHODS[methodKey];
  if (!method) return;
  const media = method.images.map((src, i) => `
    <img class="service-gallery-image" data-service-gallery="Module Cleaning / ${esc(method.title)}" src="${src}" alt="${esc(method.title)} — Maitra field imagery ${i + 1}" loading="${i === 0 ? 'eager' : 'lazy'}">
  `).join('');
  const html = `
    <p class="eyebrow eyebrow-light">O&amp;M / Module Cleaning</p>
    <h2 class="modal-title">${esc(method.title)}</h2>
    <p class="modal-sub">${esc(method.desc)}</p>
    <div class="modal-media two-col">${media}</div>
    <div class="service-detail-meta"><span>O&amp;M</span><span>${esc(method.title.toUpperCase())}</span><span>MAITRA</span></div>
...
function openOmServiceModal(name) {
  ...
  const image = name === 'Module Cleaning'
    ? `<div class="om-cleaning-options" role="list" aria-label="Module Cleaning methods">
        ${Object.entries(MODULE_CLEANING_METHODS).map(([key, method]) => `
          <article class="om-cleaning-option" data-cleaning-method="${key}" role="listitem" tabindex="0" aria-label="Open ${esc(method.title)} gallery">
            <div class="om-cleaning-option-media"><img class="service-gallery-image" data-service-gallery="Module Cleaning / ${esc(method.title)}" src="${method.images[0]}" alt="${esc(method.title)}" loading="eager"></div>
            <div class="om-cleaning-option-copy"><strong>${esc(method.title)}</strong><span>${esc(method.desc)}</span><em>VIEW GALLERY <span aria-hidden="true">→</span></em></div>
          </article>`).join('')}
      </div>`
    : (gallery.length ? `<div class="modal-media ${name === 'Reporting' ? 'reporting-detail-media' : (gallery.length > 1 ? 'two-col' : '')}">${gallery.map((src,i)=>`<img class="service-gallery-image" data-service-gallery="${esc(name)}" src="${src}" alt="${esc(name)} — Maitra field imagery ${i+1}" loading="${i===0?'eager':'lazy'}">`).join('')}</div>` : '');
  const html = `
...
function renderProjectsPanel() {
  const collectionCount = galleryGroups().length;
  const totalImageCount = GALLERY.length;
  return `<div class="ix ix-projects">
    <div class="ix-project-intro">
      <div><p class="ix-kicker">PROJECTS / FIELD WORK</p><h3>Real site.<br><span>Real work.</span></h3></div>
      <p>Field imagery aligned to the work Maitra delivers. Representative reference images are labelled where applicable.</p>
    </div>
    <div class="ix-project-tools">
      <div class="gallery-filters" role="group" aria-label="Filter project gallery">${GALLERY_FILTERS.map((f,i)=>`<button class="filter-btn ${i===0?'is-active':''}" type="button" data-filter="${f.id}">${esc(f.label)}</button>`).join('')}</div>
    </div>
    <div class="ix-project-mobile-summary" aria-label="Field portfolio summary">
      <div><span>FIELD PORTFOLIO</span><strong>${String(collectionCount).padStart(2,'0')}</strong><small>COLLECTIONS</small></div>
      <div><span>ALL IMAGES</span><strong>${String(totalImageCount).padStart(2,'0')}</strong><small>TAP "ALL" TO BROWSE</small></div>
    </div>
    <div class="ix-project-meta"><span>FIELD PORTFOLIO</span><span>IMAGE COLLECTIONS / SELECT TO EXPLORE</span></div>
    <div class="gallery-grid ix-project-grid" id="panelProjectGrid"></div>
  </div>`;
}
...
function renderLifecycleFlow() {
  ...
  if (!wrap) return;
  const nodes = FLOW_OM.map((step, i) => {
    const displayStep = i === 3 ? 'Preventive Maintenance' : step;
    return `
    <div class="flow-node" data-step="${i}">
      <span class="flow-label flow-tag">${String(i + 1).padStart(2, '0')}</span>
      <span class="flow-label">${esc(displayStep)}</span>
      <span class="flow-dot"></span>
      ${i < FLOW_OM.length - 1 ? '<span class="flow-link"></span>' : ''}
    </div>`;
  }).join('');
...
function renderGallery(gridEl) {
  ...
  gridEl.innerHTML = galleryGroups().map((group, i) => `
    <button class="g-item gallery-project-card ${i === 0 ? 'wide' : ''}" type="button" data-cat="${group.cat}" aria-label="Open ${esc(group.tag)} gallery">
      <img src="${group.cover.src}" alt="${esc(group.cover.cap || group.tag + ' project image')}" loading="lazy" onerror="this.onerror=null;this.closest('.g-item')?.classList.add('img-load-error');">
      ...
      <span class="g-project-mobile-meta" aria-hidden="true">
        <span class="g-project-mobile-index">${String(i + 1).padStart(2,'0')}</span>
        <span class="g-project-mobile-label">${esc(group.tag)}</span>
        <span class="g-project-mobile-arrow" aria-hidden="true">↗</span>
        <strong>${esc(group.cover.cap)}</strong>
        <span class="g-project-mobile-count">${group.images.length} ${group.images.length === 1 ? 'image' : 'images'}</span>
      </span>
    </button>`).join('');
...
function openLightboxEntries(entries, title) {
  lightboxEl?.classList.remove('is-project-gallery');
  lightboxList = entries || [];
  lightboxIndex = 0;
  const group = lightboxList[0]?.g;
  if (!group) return;
  if (lightboxTitle) lightboxTitle.textContent = title || group.tag;
  if (lightboxCount) lightboxCount.textContent = `${lightboxList.length} ${lightboxList.length === 1 ? 'image' : 'images'}`;

  /* Always enter the actual image viewer. The mobile overview was an
     unnecessary extra interaction step and made the gallery feel broken
     when a project card was tapped. Keep the shared viewer as the single
     source of truth for Projects and Services. */
  if (lightboxMobileOverview) lightboxMobileOverview.hidden = true;
  lightboxEl.querySelector('.lightbox-figure')?.removeAttribute('hidden');
  lightboxEl.querySelector('.lightbox-prev')?.removeAttribute('hidden');
  lightboxEl.querySelector('.lightbox-next')?.removeAttribute('hidden');
...
function openLightboxGroup(cat) {
  lightboxEl?.classList.add('is-project-gallery');
  openLightboxEntries(GALLERY.map((g, i) => ({ g, i })).filter(x => x.g.cat === cat), cat);
}

/* "All" browses the complete existing GALLERY collection, in its
   existing order, across every category — no separate dataset. */
function openLightboxAll() {
  lightboxEl?.classList.add('is-project-gallery');
  openLightboxEntries(GALLERY.map((g, i) => ({ g, i })), 'All');
}
...
function showLightboxImage() {
  ...
  if (!entry) return;
  const g = entry.g;
  lightboxEl.querySelector('.lightbox-figure')?.classList.remove('img-load-error');
  lightboxImg.onerror = () => { lightboxEl.querySelector('.lightbox-figure')?.classList.add('img-load-error'); };
  lightboxImg.src = g.src;
  lightboxImg.alt = g.cap || `${g.tag} project image`;
  ...
  if (lightboxThumbs) {
    lightboxThumbs.innerHTML = lightboxList.map((item, idx) => `
      <button class="lightbox-thumb ${idx === lightboxIndex ? 'is-active' : ''}" type="button" data-lightbox-index="${idx}" aria-label="View image ${idx + 1}">
        <img src="${item.g.src}" alt="" loading="lazy" onerror="this.onerror=null;this.closest('.lightbox-thumb')?.classList.add('img-load-error');">
      </button>`).join('');
    const activeThumb = lightboxThumbs.querySelector('.lightbox-thumb.is-active');
    activeThumb?.scrollIntoView({ block: 'nearest', inline: 'center', behavior: 'auto' });
  }

  // Preload the adjacent images so Next/Previous stays responsive on mobile.
  [lightboxIndex - 1, lightboxIndex + 1].forEach(idx => {
    const item = lightboxList[(idx + lightboxList.length) % lightboxList.length];
    if (!item) return;
    const preload = new Image();
    preload.src = item.g.src;
  });
}
...
const ASSET_NODE_COPY = {
  ...
  inspection: { index:'03', title:'Preventive Maintenance', text:'Visual, thermal and technical inspections help turn field observations into structured findings.' },
...
document.addEventListener('keydown', (e) => {
  trapOverlayFocus(e);
  if ((e.key === 'Enter' || e.key === ' ') && e.target.closest('[data-cleaning-method]')) {
    e.preventDefault();
    openModuleCleaningMethod(e.target.closest('[data-cleaning-method]').getAttribute('data-cleaning-method'));
    return;
  }
  if (e.key === 'Escape') {
  ...
  if (!lightboxEl.hidden && isMobileProjectsView() && lightboxMobileOverview && !lightboxMobileOverview.hidden) return;
...
/* Touch swipe support for the full project gallery. */
let lightboxTouchStartX = 0;
let lightboxTouchStartY = 0;
lightboxEl.addEventListener('touchstart', (e) => {
  if (lightboxEl.hidden || e.touches.length !== 1) return;
  lightboxTouchStartX = e.touches[0].clientX;
  lightboxTouchStartY = e.touches[0].clientY;
}, { passive: true });
lightboxEl.addEventListener('touchend', (e) => {
  if (lightboxEl.hidden || e.changedTouches.length !== 1) return;
  const dx = e.changedTouches[0].clientX - lightboxTouchStartX;
  const dy = e.changedTouches[0].clientY - lightboxTouchStartY;
  if (Math.abs(dx) < 48 || Math.abs(dx) < Math.abs(dy) * 1.15 || lightboxList.length < 2) return;
  lightboxIndex = (lightboxIndex + (dx < 0 ? 1 : -1) + lightboxList.length) % lightboxList.length;
  showLightboxImage();
}, { passive: true });
